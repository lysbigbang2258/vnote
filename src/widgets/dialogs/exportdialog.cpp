...
void ExportDialog::saveFields(ExportOption &p_option)
{
    ...
    if (p_option.m_htmlOption && m_advancedSettings[AdvancedSettings::HTML]) {
        saveFields(*p_option.m_htmlOption);
    }

    if (p_option.m_pdfOption && m_advancedSettings[AdvancedSettings::PDF]) {
...
QWidget *ExportDialog::getHtmlAdvancedSettings()
{
    if (!m_advancedSettings[AdvancedSettings::HTML]) {
        ...
        if (!m_option.m_htmlOption) {
            m_option.m_htmlOption = QSharedPointer<ExportHtmlOption>::create();
        }
...
QWidget *ExportDialog::getPdfAdvancedSettings()
{
    if (!m_advancedSettings[AdvancedSettings::PDF]) {
        ...
        if (!m_option.m_pdfOption) {
            m_option.m_pdfOption = QSharedPointer<ExportPdfOption>::create();
        }
